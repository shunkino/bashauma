...
# these defaults, or (b) export BASHAUMA_SCHEDULER_CMD / BASHAUMA_NEXT_CMD to
# point at the real files. Nothing else in this harness needs to change.
# ---------------------------------------------------------------------------
set -u
...
# Returns the hook's exit code; stdout/stderr are captured in
# HARNESS_LAST_OUTPUT.
